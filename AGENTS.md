...
| [docs/components.md](./docs/components.md) | How to add a bar `Component` |
| [docs/widgets.md](./docs/widgets.md) | The `ui_core`/`ui_widget`/`m3_widget` stack, the `Widget` trait, `m3_test` gallery |
...
| [docs/config.md](./docs/config.md) | `Configuration`/`Theme`/`AnimationConfig`/`FontBook` reference |
