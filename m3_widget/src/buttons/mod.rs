...
//!
//! This groups the common (action) buttons, icon buttons and radio buttons,
//! because they share a presentation vocabulary — state layers, disabled
//! treatment and press shape-morph — rather than any code
