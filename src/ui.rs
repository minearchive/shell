...
use crate::{ipc::WindowManagerIPC, KeyTiming};
...
impl UserInterface {
    pub fn new(rx: Sender<UiEvent>) -> Self {
        Self {
            components: Vec::new(),
            state: UIState::new(),
            sender: rx,
